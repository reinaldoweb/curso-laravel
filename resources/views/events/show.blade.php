...
<div class="col-md-10 offset-md-1">
    <div class="row">
        ...
        <div id="info-container" class="col-md-6">
            ...
            <p class="events-participantes"><ion-icon name="people"></ion-icon> {{ count($event->users) }} Participantes</p>
           ...
           @endif
            ...
            <ul id="items-list">
                @foreach($event->items as $item)
                    <li><ion-icon name="arrow-dropright-circle"></ion-icon><span>{{ $item }} </span> </li>
                @endforeach
            </ul>
        </div>
